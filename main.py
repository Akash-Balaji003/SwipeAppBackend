...
from DB_Interface import add_friend2, get_friends2, get_profile_data, login_user, register_user, remove_friend
...
async def lifespan(app: FastAPI):
    ...
    # Provide the db_pool as a global resource to the app
...
@app.get("/get-friend")
async def profile(data: int = Query(...)):
    db_pool = app.state.db_pool  # Access the db_pool from app state
